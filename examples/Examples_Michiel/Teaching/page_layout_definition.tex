...
\setcounter{tocdepth}{2} % titels tot en met niveau subsubsection worden in table of contents opgenomen
...
{\usefont{OT1}{pag}{b}{n}\fontsize{75}{34}\selectfont {~\thechapter}}{10pt}{\usefont{OT1}{pag}{m}{n}\fontsize{22}{24}\selectfont}[{\thispagestyle{empty}\vspace{3cm}}]
